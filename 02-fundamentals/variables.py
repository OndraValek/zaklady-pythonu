...
first_eight = name[:8]
vowels = "aeiouáéíóú"
myself_binary = ''.join('0' if char.lower() in vowels else '1' for char in first_eight)
print(myself_binary)
decimal_value = int('01110110', base=2);
print(decimal_value)
shifted_value = decimal_value >> 2
print(shifted_value)
hex_value = int("1A", 16)
soucin = decimal_value & hex_value
print(soucin)
